    ...
    <main className="min-h-screen bg-[#0a0a0a] text-white font-sans">
        ...
        <div className="max-w-5xl mx-auto px-12 py-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 divide-x divide-y divide-white/[0.06] border border-white/[0.06] rounded-lg overflow-hidden">
            {[
              {
                icon: "🚛",
                title: "Drive when you want. Join others when you feel like it.",
                desc: "No schedules, no pressure. Hop in whenever you're ready to roll.",
              },
              {
                icon: "🤝",
                title: "A relaxed community where you always belong.",
                desc: "No matter where you are on the map, feel free to say \"I'm here right now\" or \"Anyone nearby want to join?\" We value casual and natural interaction between members.",
              },
              {
                icon: "📋",
                title: "Rank System",
                desc: "Rank up based on your delivery record. Track your own growth as a driver.",
              },
              {
                icon: "🌏",
                title: "Asia Focus",
                desc: "Based around the Asia map. Explore routes across Japan and the wider Asian region.",
              },
            ].map(({ icon, title, desc }) => (
              <div
                key={title}
      ...
      <section className="bg-gradient-to-br from-[#1a0d00] to-[#0d0d0d] border-t border-orange-500/15 text-center px-12 py-20">
        ...
        <p className="text-base text-white/50 tracking-wider mb-9">
          Join our Discord and take your first step.
        </p>
